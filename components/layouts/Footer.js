                        ...
                        <div className="uk-width-large@m">
                            <div className="uk-panel">
                                <a href="landing-01.html" className="uk-logo">
                                    <img width="200" src="/images/logo-text.png" alt="Nerko" />
                                </a>
                                <p className="uk-text-xlarge@m uk-margin-medium-top@m">The Best AI Tool for Image Generation. Create content using AI 10x faster.</p>
